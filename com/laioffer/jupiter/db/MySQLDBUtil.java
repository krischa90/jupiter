...
public class MySQLDBUtil {
    private static final String INSTANCE = "di-database.cvctwxcgrag9.us-east-2.rds.amazonaws.com";
    ...
    public static String getMySQLAddress() throws IOException {
        ...
        // file could be too large, slow to read all, so use stream to read
