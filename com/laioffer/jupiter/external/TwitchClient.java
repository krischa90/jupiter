...
public class TwitchClient {
    private static final String TOKEN = "Bearer hm5dkkbbkfdp6c89zjiipuriox9ki0";
    private static final String CLIENT_ID = "f1ldda5xizdjr8wbp8i4dmlcbo3k1u";
    ...
    private static final int DEFAULT_SEARCH_LIMIT = 20; // searched default numbers
    ...
    private String buildSearchURL(String url, String gameId, int limit) {
        try {
            gameId = URLEncoder.encode(gameId, "UTF-8"); // encode for security
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return String.format(url, gameId, limit); // gameId and limit replace corresponding symbols in url
    }
    ...
    // stream clip and videos all put in map
